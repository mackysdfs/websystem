...
if (isset($_POST['submitt'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            if (isset($row['user_type']) && strtolower($row['user_type']) === 'admin') {
                ...
                header('Location: user_page.php'); // Redirect to user page (if needed)
                exit();
            }
        } else {
...
<div class="form-container">
    <form action="" method="post">
        ...
        <input type="submit" name="submitt" value="Login Now" class="form-btn">
        <p>Log-in as Student <a href="login_form.php">Log-in now</a></p>
    </form>
</div>
